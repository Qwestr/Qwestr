...
const QwestFilter = (props) => (
  <Filter {...props}>
    ...
    <QuickFilter source="complete_by_yes" label="Has Complete By Date" defaultValue={true} />
    <QuickFilter source="complete_by_no" label="No Complete By Date" defaultValue={true} />
  </Filter>
);
